...
<p>
    ...
    1. لا يوجد فرق بين الكليتين؛ حيث تستمر الدراسة في كلتيهما عادةً لمدة أربع سنوات للحصول على درجة البكالوريوس.
</p>

<p>
    <strong>نوع الشهادة:</strong><br>
    2. تُمنح الجامعة التقنية شهادة "بكالوريوس تقني"، بينما تُمنح الجامعة الاعتيادية شهادة "بكالوريوس".
</p>

<p>
    <strong>التركيز في المنهج الدراسي:</strong><br>
    3. في الجامعة التقنية، يتم التركيز بشكل أكبر على الجوانب العملية والتطبيقية، مع تقديم تدريب عملي مكثف يتماشى مع المهارات التقنية المطلوبة في سوق العمل. وقد لا تتواجد بعض الأقسام في الجامعة التقنية التي قد تكون موجودة في الجامعة الاعتيادية.<br>
    4. في الجامعة الاعتيادية، يتم التركيز بشكل رئيسي على الجانب النظري، مع وجود تدريبات عملية أقل مقارنةً بالجامعة التقنية.
</p>
...
<h6>متطلبات التسجيل / التقديم في الجامعات  الحكومية</h6>
<p>
*هذه فقط الجامعات الحكومية وليست الاهلية.<br>
    ...
    4. عشر صور ملونة.<br>
    5. مبلغ قدره 60,000 دينار.<br>
    6. فحص عين + فحص نوع الدم.<br>
    7. درجات الصف السادس مصدقة.<br>
    8. كفيل موظف في الدولة، بشرط أن لا يقل راتب الكفيل عن 250,000 دينار، وأن يكون الكفيل حاضراً مع الطالب.<br>
    * أن المتطلبات تختلف من جامعة إلى أخرى ومن مدينة إلى أخرى.
</p>

<p>
    <strong>بالنسبة لحاملي الجنسيات الأخرى:</strong><br>
    10. قد تختلف الشروط، حيث يتم استبدال الجنسية بالإقامة.
</p>
...
<p>
    <strong>1. لغة الدراسة العامة:</strong> تعتمد لغة الدراسة في الجامعة على القسم والجامعة بشكل عام.
</p>

<p>
    <strong>2. كليات الإدارة والاقتصاد وكلية القانون:</strong><br>
    يتم تدريس المواد، إجراء الامتحانات، كتابة التقارير، وغيرها من الأنشطة باللغة العربية. ومع ذلك، فإن الشرح من قبل الأساتذة يتم عادةً باللغة الكوردية، وقد يستخدم بعض الأساتذة اللغة العربية أحياناً.
</p>

<p>
    <strong>3. بقية الأقسام:</strong><br>
    تكون لغة الدراسة باللغة الإنجليزية، في حين يُقدَّم الشرح من قبل الأساتذة باللغتين الكوردية والإنجليزية.
</p>

<p>
    <strong>4. الجامعات الأهلية:</strong><br>
    قد يقوم بعض الأساتذة بشرح المواد باللغة العربية عند طلب الطلاب ذلك، ولكن بشكل عام، يتم تقديم الشرح باللغة الكوردية، بينما تكون مواد الدراسة باللغة الإنجليزية أو العربية حسب القسم.
</p>
...
<p>
    <strong>1. تعريف المادة:</strong><br>
 مادة الكوردولوجي او كوردناسى مادة تُدرس في الجامعات في السنة الأولى فقط.
</p>

<p>
    <strong>2. محتويات الكتاب:</strong><br>
    تختلف محتويات الكتاب المخصص لهذه المادة من جامعة إلى أخرى، ولكن بشكل عام تشمل دراسة <strong>تاريخ كردستان، الأديان، الإمارات، والجغرافيا الكردية</strong>. تُقيَّم المادة بنفس الطريقة التي تُقيَّم بها باقي المواد الدراسية، ويتم تدريسها وشرحها باللغة الكوردية.
</p>
...
<p>
    ...
    في بعض الجامعات الأهلية، قد يتم تدريس مادة الكوردولوجي باللغة العربية بناءً على طلب الطلاب.
</p>
